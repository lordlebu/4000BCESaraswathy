...
`SouthOfTethys` repository and now exports *its own shape* rather than this engine's: 723 entities
...
drops the `lore` ones on the way out, so the bundle this repo reads holds **344** (232 fauna, 112
