...
`SouthOfTethys` repository and now exports *its own shape* rather than this engine's: 755 entities
...
drops the `lore` ones on the way out, so the bundle this repo reads holds **348** (236 fauna, 112
