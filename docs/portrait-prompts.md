...
## What the three tools did with Thrali

The first subject was generated by all three against the same block, exactly as the plate queue
was. The predictions in `docs/plate-prompts.md` held without a single change:
